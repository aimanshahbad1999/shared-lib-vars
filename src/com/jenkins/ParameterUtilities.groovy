          ...
          values.meta.each{
            if(it.stringPeerName){
              if(it.stringPeerNeedsTextParam == true)
                paramArray.push(textParameter(["name": it.stringPeerName, "description": it.stringPeerDescription, "defaultValue": it.fileName]))
              else
                paramArray.push(stringParameter(["name": it.stringPeerName, "description": it.stringPeerDescription, "defaultValue": it.fileName, "trim": true]))
            }
          }
        }
